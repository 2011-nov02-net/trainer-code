...
{
    // here, I've moved all the code that converts between the EF model and the business model,
    // for the sake of DRY principle and single responsibility principle.
    // but it's not suitable for all cases. recursive mapping logic like this can be a pitfall.
    // I recommend writing this code case-by-case in the repository implementation,
    // and only later considering reducing code duplication by moving common parts of it into
    // helper methods like these.
